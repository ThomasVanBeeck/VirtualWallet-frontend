...
export class RegisterComponent {
  ...
  protected readonly usernameCtrl = this.fb.control('', [Validators.required, Validators.minLength(7), Validators.maxLength(25)], [this.userService.validateUsername()])
  protected readonly firstNameCtrl = this.fb.control('', [Validators.required, Validators.maxLength(50)])
  protected readonly lastNameCtrl = this.fb.control('', [Validators.required, Validators.maxLength(50)])
  protected readonly emailCtrl = this.fb.control('', [Validators.required, Validators.email, Validators.maxLength(255)])
  protected readonly passwordCtrl = this.fb.control('', [Validators.required, Validators.minLength(12), Validators.maxLength(25)])
  protected readonly passwordRepeatCtrl = this.fb.control('', [Validators.required, Validators.minLength(12), Validators.maxLength(25)])
